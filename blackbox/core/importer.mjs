const MAX=1024*1024;
// Shared with blackbox/core/live-import.mjs. No /g flag: `.test` stays stateless.
export const UNSAFE_FIELD_PATTERN=/(^|["'\s])(?:secret|preimage|witness|privateKey|private_key|seed|mnemonic|passphrase|apiKey|token)(?=["'\s:]|$)/i;
const unsafe=UNSAFE_FIELD_PATTERN;
