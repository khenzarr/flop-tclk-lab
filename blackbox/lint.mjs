...
const spawnAllowed=new Set([join('blackbox','typecheck.mjs'),join('lab','compat-matrix.mjs'),join('lab','candidate-probe.mjs'),join('blackbox','airlock','detached-bridge.mjs'),join('blackbox','tests','phase3a7.test.mjs')]);
