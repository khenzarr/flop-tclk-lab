...
// Network APIs remain banned everywhere, including in those three.
const spawnApi=/\bnode:child_process\b/;
const spawnAllowed=new Set([join('blackbox','typecheck.mjs'),join('lab','compat-matrix.mjs'),join('lab','candidate-probe.mjs')]);
